    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-6 relative z-20 text-center">
                <h1 className="hero-text text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
                ...
                <p className="hero-text text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
                    {subtitle}
                </p>
                <div className="hero-text">
                    <MagneticButton variant="primary" href={ctaLink} className="text-lg px-10 py-5">
                        {ctaText}
                    </MagneticButton>
                </div>
            </div>
            ...
            <motion.div
                ...
                className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 group"
            >
                <motion.div
                    animate={{ y: [0, 8, 0] }}
